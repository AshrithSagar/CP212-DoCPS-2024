...
\begin{tikzpicture}
    ...
    % Bits
    \node at (0.5, 0.5) {\LARGE \textbf 0};
    \node at (1.5, 0.5) {\LARGE \textbf 1};
    \node at (2.5, 0.5) {\LARGE \textbf 0};
    \node at (3.5, 0.5) {\LARGE \textbf 0};
    \node at (4.5, 0.5) {\LARGE \textbf 0};
    \node at (5.5, 0.5) {\LARGE \textbf 0};
    \node at (6.5, 0.5) {\LARGE \textbf 0};
    \node at (7.5, 0.5) {\LARGE \textbf 0};
    \node at (8.5, 0.5) {\LARGE \textbf 1};
    \node at (9.5, 0.5) {\LARGE \textbf 0};
    \node at (10.5, 0.5) {\LARGE \textbf 1};
